...
<div>
  <p><b>Задание:</b> выполнить операции с транзакциями в базе данных: создать транзакцию, выполнить откат и фиксацию, продемонстрировать изменение данных. Подготовить и выполнить сценарии проверки уровней изоляции транзакций.</p>

  <p><b>В рамках задания необходимо:</b></p>
  <ol type="1">
    <li>Создать транзакцию, внести изменения, проверить наличие данных.</li>
    <li>Выполнить откат транзакции и показать исчезновение данных.</li>
    <li>Повторно внести данные и выполнить фиксацию.</li>
    <li>Подготовить набор SQL-сценариев для проверки изолированности транзакций.</li>
  </ol>

  <p><b>Для проверки изолированности транзакций требуется:</b></p>
  <ol type="1">
    <li>Установить уровни изоляции READ UNCOMMITTED, READ COMMITTED, REPEATABLE READ и SERIALIZABLE.</li>
    <li>Выполнить проверки:
      <ul>
        <li>потерянных изменений,</li>
        <li>грязного чтения,</li>
        <li>неповторяющегося чтения,</li>
        <li>фантомного чтения.</li>
      </ul>
    </li>
    <li>Зафиксировать протокол выполнения каждого сценария.</li>
  </ol>

  <p><b>Отчёт должен содержать:</b></p>
  <ol type="1">
    <li>Подробные SQL-сценарии, использованные для проверки транзакций.</li>
    <li>Протоколы выполнения в двух сеансах.</li>
    <li>Описание наблюдаемых эффектов на каждом уровне изоляции.</li>
    <li>Краткие выводы о приобретённых навыках работы с транзакциями.</li>
  </ol>

  <h4>№1. Выполнение транзакции</h4>
  <p>Демонстрация создания транзакции, выполнения ROLLBACK и COMMIT, а также изменения данных на каждом этапе.</p>

  <h4>№2. Проверка изолированности транзакций</h4>
  <p>Сценарии тестирования поведения транзакций при разных уровнях изоляции.</p>

  <h4>Протоколы</h4>
  <p>Последовательные записи действий в Сеансе 1 и Сеансе 2, с указанием полученного результата.</p>

  <h4>Выводы</h4>
  <p>Оценка различий в поведении транзакций и эффектов изоляции, понимание механизмов блокировок и сохранности данных.</p>
</div>
