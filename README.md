...
<div>
  ...
  <p><b>Задание 1:</b></p>
  <ol>
    <li>Использовать реляционную БД из лабораторной работы №2.</li>
    <li>Продумать и создать графовые таблицы по реляционной БД.</li>
    <li>Заполнить графовые таблицы, используя данные из реляционных таблиц.</li>
    <li>Написать запросы из задания 3.2, используя паттерн <code>MATCH</code>.</li>
    <li>Сравнить полученные результаты с результатами запросов к реляционной модели.</li>
  </ol>
  
  <p><b>Отчет должен содержать:</b></p>
  <ul>
    <li>Схему узлов и ребер графовой модели.</li>
    <li>Скрипт для создания и заполнения графовых таблиц.</li>
    <li>Запросы из задания 3.2 для двух моделей: реляционной и графовой.</li>
  </ul>
</div>
